...
//! Exercise template - do not modify
// Exercise by Mike North: https://www.typescript-training.com/course/fundamentals-v4/14-dict-map-filter-reduce/

// Implement MAP, FILTER, AND REDUCE - Instead of arrays in dict like data structures
// Implement it like used in dictionaries basics/generics
